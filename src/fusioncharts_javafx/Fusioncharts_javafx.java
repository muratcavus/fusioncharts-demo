			...
			public void handle(ActionEvent event) {
				...
				try {
					...
					engine.loadContent("<html>\n" 
							...
							+ "<script type=\"text/javascript\" src=\"" + urlFusionchartsjs.toString() + "\"></script>\n" 
							+ "<script type=\"text/javascript\" src=\""+ urlFusionchartsthemejs.toString() + "\"></script>\n"
							+ "<script type=\"text/javascript\">\n" +
							
							//your fusioncharts method goes here:
